...
All themes have opinions on content and layout. For example, Zafta uses "post" over "docs". Strong opinions make for simpler templates but differing opinions make it tougher to use themes. When you build a theme, consider using the terms that other themes do.
