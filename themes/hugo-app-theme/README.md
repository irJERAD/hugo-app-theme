# Hugo App Theme for Hugo

[![Build Status](https://travis-ci.org/devcows/hugo-app-theme.svg?branch=master)](https://travis-ci.org/devcows/hugo-app-theme)
[![Code Climate](https://codeclimate.com/github/devcows/hugo-app-theme/badges/gpa.svg)](https://codeclimate.com/github/devcows/hugo-app-theme)

Hugo App is a clean and stylish website template built with Bootstrap. It stands out with its clean design and elegant typography.
...
![screenshot](https://raw.githubusercontent.com/devcows/hugo-app-theme/master/images/screenshot.png)
...
* [Configuration](#configuration)
  ...
  * [Docs post thumbnails](#docs-post-thumbnails)
  * [Top bar](#top-bar)
...
$ mkdir themes
$ cd themes
$ git clone https://github.com/devcows/hugo-app-theme
```
...
After installing the Hugo App theme successfully, we recommend you to take a look at the [exampleSite](//github.com/devcows/hugo-app-theme/tree/master/exampleSite) directory. You will find a working Hugo site configured with the Hugo App theme that you can use as a starting point for your site.

First, let's take a look at the [config.toml](//github.com/devcows/hugo-app-theme/tree/master/exampleSite/config.toml). It will be useful to learn how to customize your site. Feel free to play around with the settings.
...
You can enable/disable the sidebar widgets that will be shown in the docs section. The following widgets are currently available:
...
[params.topbar]
    enable = true
    text = "<p>Contact us on +420 777 555 333 or hello@hugo-app.com.</p>"
```
...
[[menu.topbar]]
    weight = 1
    name = "GitHub"
    url = "https://github.com/devcows/hugo-app-theme"
...
The recent posts sections shows the four latest published docs posts, with their featured image and a summary. It defaults to show recent posts from all [main sections](https://gohugo.io/functions/where/#mainsections). This is either the section with the most posts or can be set explicitly in the configuration file (see linked docs).
...
Did you found a bug or got an idea for a new feature? Feel free to use the [issue tracker](https://github.com/devcows/hugo-app-theme/issues) to let us know. Or make directly a [pull request](https://github.com/devcows/hugo-app-theme/pulls).
